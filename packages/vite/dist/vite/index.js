...
// src/vite/vite-plugin-wave-css.ts
...
// src/vite/vite-plugin-wave-css.ts
var WAVE_CSS = "@wave.css";
var VIRTUAL_PATH = "/" + WAVE_CSS;
var BUILD_PLACEHOLDER = `#--wave-css--{top:1}`;
  ...
  return [
    {
      ...
      resolveId: (id) => id === WAVE_CSS || id === VIRTUAL_PATH ? VIRTUAL_PATH : void 0,
      load: (id) => {
        if (id === VIRTUAL_PATH) {
          return makeStyle();
        }
    ...
    },
    {
      ...
      generateBundle(options, bundle) {
        const waveCSS2 = makeStyle();
        for (const chunk of Object.values(bundle)) {
          if (chunk.type === "asset" && typeof chunk.source === "string") {
            chunk.source = chunk.source.replace(BUILD_PLACEHOLDER, waveCSS2);
          }
        }
      }
    }
