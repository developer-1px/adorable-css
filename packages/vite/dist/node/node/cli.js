...
var require_tidy_rules = __commonJS({
  "node_modules/clean-css/lib/optimizer/level-1/tidy-rules.js"(exports, module2) {
    ...
    function replacePseudoClasses(value) {
      return value.replace("nth-child(1)", "first-child").replace("nth-of-type(1)", "first-of-type").replace("nth-of-type(even)", "nth-of-type(2n)").replace("nth-child(even)", "nth-child(2n)").replace("nth-of-type(2n+1)", "nth-of-type(odd)").replace("nth-child(2n+1)", "nth-child(odd)");
    }
