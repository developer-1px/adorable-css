...
`],{type:"text/javascript"}));return require(["vs/editor/editor.main"],function(){monaco.editor.defineTheme("adorableCSS",kt),a=monaco.editor.create(i,{value:r,language:"html",automaticLayout:!0,scrollBeyondLastLine:!1,readOnly:!1,theme:"adorableCSS",tabSize:2,fontSize:"13px",overviewRulerLanes:0,wordWrap:"on",minimap:{enabled:!1}}),a.onDidChangeModelContent(m=>{o(1,r=a.getValue())}),a.addCommand(monaco.KeyMod.CtrlCmd|monaco.KeyCode.KeyS,function(){a.getAction("editor.action.formatDocument").run()})}),()=>{a&&a.dispose()}});function n(u){J[u?"unshift":"push"](()=>{i=u,o(0,i)})}return e.$$set=u=>{"value"in u&&o(1,r=u.value)},[i,r,f,n]}class At extends xe{constructor(t){super();ke(this,t,Dt,yt,ye,{value:1,setValue:2})}get setValue(){return this.$$.ctx[2]}}const $e=`
<!--
\u0E05^\u2022\uFECC\u2022^\u0E05 \u2665
